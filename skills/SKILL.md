...
description: 开源项目深度分析专家。当用户要求分析、评估、学习或审计任意开源项目时使用此 Skill。按 6 阶段结构化流程结合 GitNexus 知识图谱执行分析，输出各维度 1-4 评分的标准化报告。
# EXTENDED METADATA (MANDATORY)
github_url: https://github.com/weksbwrx62862/project-analysis-rules
github_hash: d8259ff02d41731389f31a45f145170a3f7bb555
version: 1.0.0
